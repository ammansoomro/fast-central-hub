...
import { CoursePage, CourseList, DepartmentPage, DepartmentList, TeacherPage, TeacherList, SocietyPage, SocietyList, Material, Home, PageNotFound, ProjectList, Login,Navbar, Footer,Register,Project,AnnouncementsList} from "./pages/ExportAll";
